CommonTranslationTable = {
	...
	["$AkarinPlayer"] = "%from 从 %to 的视野中消失",
	["$AkarinPlayerToAll"] = "%from 从大家的视野中消失",
	["$RemoveAkarin"] = "%from 从 %to 的视野中重新出现。",
	["$RemoveAkarinToAll"] = "%from 从大家的视野中重新出现。",
	...
	["$PutCardBottom"] = "%from 的 %card 被置于牌堆底",
	["#PutCardBottom"] = "%from 的 %arg 张牌被置于牌堆底",
	["normal_nature"] = "无属性",
	["fire_nature"] = "火属性",
	["thunder_nature"] = "雷属性",
