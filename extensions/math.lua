-- module("Maths.math",package.seeall)
Math=sgs.Package("math")

Seniorious=sgs.General(Math,"Seniorious","magic",4,false)
oumashu=sgs.General(Math,"oumashu","science",4)
Inori=sgs.General(Math,"Inori","science",3,false)
oumamana=sgs.General(Math,"oumamana","science",2,false,true)
MiyanagaTeru=sgs.General(Math,"MiyanagaTeru","real",4,false)
OohoshiAwai=sgs.General(Math,"OohoshiAwai","real",4,false)
Kyousuke=sgs.General(Math,"Kyousuke","real",4)
kirino=sgs.General(Math,"kirino","real",3,false)
shido=sgs.General(Math,"shido","magic",4)
...
Math:insertRelatedSkills("mshengjian", "#mshengjian_tri")
...
Math:insertRelatedSkills("zhaojing", "#zhaojing2")
Math:insertRelatedSkills("lianzhuang","#lianzhuangeffect")
OohoshiAwai:addSkill(wlizhi)
OohoshiAwai:addSkill(wlizhi1)
OohoshiAwai:addSkill(wlizhi2)
Math:insertRelatedSkills("wlizhi", "#wlizhi1")
Math:insertRelatedSkills("wlizhi", "#wlizhi2")
