...
void StartScene::printServerInfo()
{
    ...
    if (Config.Enable2ndGeneral) {
        ...
        case 1: scheme_str = QString(tr("Sum - %1")).arg(Config.Scheme0Subtraction); break;
        case 2: scheme_str = tr("Minimum"); break;
        case 3: scheme_str = tr("Maximum"); break;
        case 0: scheme_str = tr("Average"); break;
        }
